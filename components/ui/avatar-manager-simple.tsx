...
interface AvatarManagerSimpleProps {
  user: UserType;
  size?: "sm" | "md" | "lg" | "xl";
  showName?: boolean;
  showEmail?: boolean;
...
export default function AvatarManagerSimple({
  user,
  size = "lg",
  showName = true,
  showEmail = true,
  ...
  // Hook personalizado para manejar avatares
  const {
    uploadAvatar,
    deleteAvatar,
  ...
  // Estados de loading
  const isLoading = isUploading || isDeleting || isGenerating;
