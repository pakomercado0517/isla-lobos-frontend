      ...
      <CardContent>
        ...
        {salidas.length > 0 ? (
          <div className="space-y-4">
            {salidas.map((salida) => (
              <Card key={salida.id} className="border-l-4 border-l-[var(--isla-teal)] hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge
                            className={`${getEstadoColor(salida.estado)} px-3 py-1`}
                          >
                      ...
                      {salida.observaciones && (
                        <div className="bg-gray-50 p-3 rounded-lg">
                          ...
                          <p className="text-sm text-gray-800">{salida.observaciones}</p>
                        </div>
                      )}
                    </div>
